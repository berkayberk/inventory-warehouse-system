...
/**
 * Represents a goods supplier that delivers merchandise to the warehouse.
 */
public class Supplier {
    ...
    public Supplier(String name, String contact, String address, String phone, String email) {
        this.name = name;
